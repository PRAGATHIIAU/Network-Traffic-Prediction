...
# features = pd.get_dummies(features, columns=['SourceIPaddress', 'DestinationIPaddress'])
...
#     'SourceIPaddress': ['59.166.0.0'],
#     'DestinationIPaddress': ['149.171.126.6'],
#     'st_time': [1421927414],
#     'end_time': [1421927414]
# })
...
# # Predict with both models
# new_predictionTree = model1.predict(new_sample)
# new_predictionKNN = model2.predict(new_sample)
...
# print("KNN Prediction for New Sample:", decoded_predictionKNN)
...
# Extract features
features = data[['SourceIPaddress', 'DestinationIPaddress', 'forward_pkts', 
                 'backward_pkts', 'st_time', 'end_time', 'Source_jitter', 'Destination_jitter']].copy()
